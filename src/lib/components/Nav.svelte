...
<header class="site-nav">
	<div class="container nav-inner">
		...
		<div class="nav-user">
			{#if profile}
				<a href="/notifications" class="bell" data-sveltekit-preload-data="off" class:active={isActive('/notifications')} aria-label="Notifications{unread.notifications ? `, ${unread.notifications} unread` : ''}">
